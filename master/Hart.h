 ...
 * Copyrigth 2010-2015   CWP Schoenmakers   kees2@schoen.mine.nu
 * 
 * 
...
//
// configuration spec
// check one or both of the next defines
//
#if !defined (HAS_DATABASE) && !defined(HAS_TABLEFILE)
#error "No frame layout definition method defined in Hart.h!!\n";
#endif
...
#define	ZERO				0
#define US_SLEEP_1MS		1000				// adjust if applicable
